...
{\em sequence} & \hyperlink{classA}{A} reference to the sequence that this action will be added to. \\
\hline
{\em func\-Ptr} & \hyperlink{classA}{A} pointer to the function that will need to be called. \\
\hline
\end{DoxyParams}
