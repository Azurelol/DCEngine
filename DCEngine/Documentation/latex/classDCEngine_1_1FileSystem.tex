...
\hyperlink{classA}{A} string containing the corrected path. \textbackslash{} 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{classA}{A} boolean determining the success of the operation. \textbackslash{} 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{classA}{A} string containing the file path. \textbackslash{} 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{classA}{A} string containing the file path. 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{classA}{A} boolean denoting whether the directory exists or not. 
\end{DoxyReturn}
...
\hline
{\em file\-Paths} & \hyperlink{classA}{A} vector containing all the file paths. \\
\hline
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{classA}{A} new string containing the extension's name. \textbackslash{} 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{classA}{A} new string without the extension. 
\end{DoxyReturn}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000037}{Todo}]C\-U\-R\-R\-E\-N\-T\-L\-Y N\-O\-T D\-O\-I\-N\-G A\-S A\-D\-V\-E\-R\-T\-I\-S\-E\-D. \end{DoxyRefDesc}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{classA}{A} new string without the extension or path \textbackslash{} 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{classA}{A} new string without the path \textbackslash{} 
\end{DoxyReturn}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
\hyperlink{classA}{A} relative path. \textbackslash{} 
\end{DoxyReturn}
