...
A reference to the container of active \hyperlink{classDCEngine_1_1GameObject}{Game\-Object}. 
\end{DoxyReturn}
...
\begin{DoxyReturn}{Returns}
A pointer to the \hyperlink{classDCEngine_1_1GameObject}{Game\-Object} that was added. 
\end{DoxyReturn}
\begin{DoxyNote}{Note}
...
\end{DoxyNote}
\begin{DoxyReturn}{Returns}
A pointer to the \hyperlink{classDCEngine_1_1GameObject}{Game\-Object}. 
\end{DoxyReturn}
...
{\em properties} & A pointer to the object containing the properties. \\
\hline
\end{DoxyParams}
\begin{DoxyNote}{Note}
...
\begin{DoxyReturn}{Returns}
A pointer to the \hyperlink{classDCEngine_1_1GameObject}{Game\-Object} that was added. N\-U\-L\-L if the \hyperlink{classDCEngine_1_1GameObject}{Game\-Object} was not found. 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
{\em level} & A handle to the level resource. \\
\hline
\end{DoxyParams}
