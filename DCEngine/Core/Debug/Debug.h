...
namespace DCEngine
{
  ...
  // Factory
#define DCE_TRACE_FACTORY_GAMEOBJECT_CONSTRUCTION 1
#define DCE_TRACE_FACTORY_COMPONENT_CONSTRUCTION 1
#define DCE_TRACE_FACTORY_COMPONENT_MAP 1
#define DCE_TRACE_FACTORY_RESOURCE_ADD 1
