/******************************************************************************/
/*!
@file   EditorInspector.hpp
@author Christian Sagel
@par    email: c.sagel\@digipen.edu
@date   1/24/2015
@brief  The file that holds all template functions used by the EditorInspector.
...
namespace DCEngine {
  namespace Systems {
    ...
    */
    /**************************************************************************/
    template<typename PropertyType>
    void EditorInspector::CheckUnsigned(Zilch::Property * property, PropertyType & value)
    {
