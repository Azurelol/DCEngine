...
namespace YTE
{
  namespace Event
  {
    ...
    {
    public:
      ZilchDeclareDerivedType(Event, Object);
      virtual ~Event() {};
    };
    ...
    class ZilchEventCallback : public EventCallback
    {
    public:
      void Invoke(Event* e) override;
    ...
    class BaseEventHandler : public Core::Object
    {
    public:
      ZilchDeclareDerivedType(BaseEventHandler, Object);
